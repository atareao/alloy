...
export default function SummaryDialog({
  ...
  const hasUpdates = updateResults.done > 0 || updateResults.failed > 0;
    ...
    >
      <Space direction="vertical" size="middle" style={{ width: "100%" }}>
        ...
        <Card bordered size="small">
          <Text
            type="secondary"
            style={{ fontSize: 14, marginBottom: 4, display: "block" }}
          >
            🔍 Comprobación
          </Text>
          <Flex gap={24}>
        ...
        {/* Errors */}
        {allErrors.length > 0 && (
          <Card bordered size="small" style={{ background: "#fff2f0" }}>
            <Text
              style={{
                fontSize: 12,
                fontWeight: 500,
